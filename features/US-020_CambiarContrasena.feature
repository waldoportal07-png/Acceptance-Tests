Feature: US-020 CambiarContrasena

  As a usuario de VitaControl
  I want to utilizar la funcionalidad de CambiarContrasena
  So that pueda gestionar mi información de forma eficiente.

  Scenario: Operación exitosa
    Given que el usuario se encuentra en la pantalla de CambiarContrasena
