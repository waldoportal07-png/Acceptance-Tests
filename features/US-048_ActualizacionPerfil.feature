Feature: US-048 ActualizacionPerfil

  As a usuario de VitaControl
  I want to utilizar la funcionalidad de ActualizacionPerfil
  So that pueda gestionar mi información de forma eficiente.

  Scenario: Operación exitosa
    Given que el usuario se encuentra en la pantalla de ActualizacionPerfil
