Feature: US-028 ActividadFisica

  As a usuario de VitaControl
  I want to utilizar la funcionalidad de ActividadFisica
  So that pueda gestionar mi información de forma eficiente.

  Scenario: Operación exitosa
    Given que el usuario se encuentra en la pantalla de ActividadFisica
