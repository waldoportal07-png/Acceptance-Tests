Feature: US-021 ValidarFormulario

  As a usuario de VitaControl
  I want to utilizar la funcionalidad de ValidarFormulario
  So that pueda gestionar mi información de forma eficiente.

  Scenario: Operación exitosa
    Given que el usuario se encuentra en la pantalla de ValidarFormulario
