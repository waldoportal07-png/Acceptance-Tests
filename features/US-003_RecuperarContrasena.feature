Feature: US-003 RecuperarContrasena

  As a usuario de VitaControl
  I want to utilizar la funcionalidad de RecuperarContrasena
  So that pueda gestionar mi información de forma eficiente.

  Scenario: Operación exitosa
    Given que el usuario se encuentra en la pantalla de RecuperarContrasena
