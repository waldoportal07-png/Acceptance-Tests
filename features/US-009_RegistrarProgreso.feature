Feature: US-009 RegistrarProgreso

  As a usuario de VitaControl
  I want to utilizar la funcionalidad de RegistrarProgreso
  So that pueda gestionar mi información de forma eficiente.

  Scenario: Operación exitosa
    Given que el usuario se encuentra en la pantalla de RegistrarProgreso
